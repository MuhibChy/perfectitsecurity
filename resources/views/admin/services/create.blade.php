...
<div class="max-w-4xl">
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white mt-2">Create New Service</h1>
    </div>
    ...
    <form method="POST" action="{{ route('admin.services.store') }}" class="space-y-6">
        ...
        <div class="glass-card p-6">
            ...
            <div class="grid md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="subcategory" value="{{ old('subcategory') }}" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-sm">
                </div>
                <div>
                    ...
                    <select name="complexity_level" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-sm">
                        <option value="basic" {{ old('complexity_level') == 'basic' ? 'selected' : '' }}>Basic</option>
                        <option value="standard" {{ old('complexity_level', 'standard') == 'standard' ? 'selected' : '' }}>Standard</option>
                        <option value="advanced" {{ old('complexity_level') == 'advanced' ? 'selected' : '' }}>Advanced</option>
                        <option value="enterprise" {{ old('complexity_level') == 'enterprise' ? 'selected' : '' }}>Enterprise</option>
                    </select>
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" name="estimated_completion" value="{{ old('estimated_completion') }}" placeholder="e.g. 3-5 business days" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-sm">
                </div>
                <div class="md:col-span-2">
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Short Description</label>
                    <input type="text" name="short_description" value="{{ old('short_description') }}" maxlength="500" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-sm">
                </div>
                <div class="md:col-span-2">
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Full Description</label>
                    <textarea name="description" rows="4" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-sm">{{ old('description') }}</textarea>
                </div>
            </div>
        </div>
        ...
        <div class="glass-card p-6">
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400 mb-4">Set independent prices for each market. All prices are from the database.</p>
            <div class="space-y-4">
                ...
                <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                    ...
                    <div class="grid md:grid-cols-3 gap-3">
                        ...
                        <div>
                            ...
                            <input type="number" name="country_prices[{{ $country->id }}][price]" step="0.01" min="0" value="0" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-sm">
                        </div>
                        <div>
        ...
        <div class="glass-card p-6">
            ...
            <div class="grid md:grid-cols-2 gap-4">
                <div>
                    ...
                    <textarea name="deliverables" rows="4" placeholder="Vulnerability report&#10;Risk assessment&#10;Remediation plan" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-sm">{{ old('deliverables') }}</textarea>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Features (one per line)</label>
                    <textarea name="features" rows="4" placeholder="Automated scanning&#10;Manual verification&#10;Risk scoring" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-sm">{{ old('features') }}</textarea>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Scope</label>
                    <textarea name="scope" rows="3" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-sm">{{ old('scope') }}</textarea>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Exclusions</label>
                    <textarea name="exclusions" rows="3" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-sm">{{ old('exclusions') }}</textarea>
                </div>
                <div class="md:col-span-2">
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Tags (one per line)</label>
                    <textarea name="tags" rows="2" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-sm">{{ old('tags') }}</textarea>
                </div>
            </div>
        </div>
        ...
        <div class="glass-card p-6">
            ...
            <div class="grid md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="seo_title" value="{{ old('seo_title') }}" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-sm">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Icon (emoji or text)</label>
                    <input type="text" name="icon" value="{{ old('icon') }}" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-sm">
                </div>
                <div class="md:col-span-2">
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">SEO Description</label>
                    <textarea name="seo_description" rows="2" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-sm">{{ old('seo_description') }}</textarea>
                </div>
                <div class="md:col-span-2 flex gap-6">
                    <label class="flex items-center gap-2">
                        ...
                        <span class="text-sm text-gray-700 dark:text-gray-300">Featured Service</span>
                    </label>
                    <label class="flex items-center gap-2">
                    ...
                    <label class="flex items-center gap-2">
                        <input type="checkbox" name="allows_custom_quote" value="1" {{ old('allows_custom_quote') ? 'checked' : '' }} class="rounded border-gray-300 text-blue-600">
                        <span class="text-sm text-gray-700 dark:text-gray-300">Allow Custom Quote</span>
                    </label>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Sort Order</label>
                    <input type="number" name="sort_order" value="{{ old('sort_order', 0) }}" min="0" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-sm">
                </div>
            </div>
        </div>
        ...
        <div class="flex justify-end gap-3">
            ...
            <button type="submit" class="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 text-sm font-medium">Create Service</button>
        </div>
    </form>
</div>
@endsection
